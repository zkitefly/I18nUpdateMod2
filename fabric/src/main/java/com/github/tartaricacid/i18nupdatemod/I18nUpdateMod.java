...
public class I18nUpdateMod implements ClientModInitializer {
    ...
    public static final String LANG_PACK_FILE_NAME = "Minecraft-Mod-Language-Modpack-1-16-FabricT1-15-Fabric.zip";
    public static final String MD5_FILE_NAME = "1.16-fabrict1.15-fabric.md5";
    ...
    public static final String LINK = "https://gitcode.net/chearlai/translationpackconvert/-/raw/main/files/" + LANG_PACK_FILE_NAME;
    public static final String MD5 = "https://gitcode.net/chearlai/translationpackconvert/-/raw/main/files/" + MD5_FILE_NAME;
